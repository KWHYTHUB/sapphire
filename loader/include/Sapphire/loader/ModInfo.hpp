...
#pragma warning(suppress : 4996)
    ...
    public:
         ...
         */
        static Result<ModInfo> createFromSapphireZip(utils::file::Unzip& zip);
        /**
         * Create ModInfo from a .sapphire package
         */
        static Result<ModInfo> createFromSapphireFile(ghc::filesystem::path const& path);
        /**
...
template <>
struct [[deprecated]] json::Serialize<sapphire::ModInfo> {
    static json::Value to_json(sapphire::ModInfo const& info) {
        return info.toJSON();
    }
};
