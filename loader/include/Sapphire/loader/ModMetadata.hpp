...
namespace sapphire {
    ...
    public:
        ...
        struct GEODE_DLL Dependency {
            ...
            [[deprecated]] operator sapphire::Dependency();
            [[deprecated]] operator sapphire::Dependency() const;

            [[deprecated]] static Dependency fromDeprecated(sapphire::Dependency const& value);
        };
        ...
        struct IssuesInfo {
            ...
            [[deprecated]] operator sapphire::IssuesInfo();
            [[deprecated]] operator sapphire::IssuesInfo() const;

            [[deprecated]] static IssuesInfo fromDeprecated(sapphire::IssuesInfo const& value);
        };
         ...
         * <Sapphire/ui/MDTextArea.hpp>) for more info
         */
        ...
        /**
         * Create ModInfo from an unzipped .sapphire package
         */
        static Result<ModMetadata> createFromSapphireZip(utils::file::Unzip& zip);
        /**
         * Create ModInfo from a .sapphire package
         */
...
template <>
struct json::Serialize<sapphire::ModMetadata> {
    static json::Value to_json(sapphire::ModMetadata const& info) {
        return info.toJSON();
    }
};
