...
namespace sapphire {
     ...
     */
    template<class T>
    class SapphireSettingChangedFilter : public SettingChangedFilter {
    public:
        ...
        SapphireSettingChangedFilter(
            std::string const& modID,
            std::string const& settingID
        ) : SettingChangedFilter(modID, settingID) {}
        SapphireSettingChangedFilter(SapphireSettingChangedFilter const&) = default;
    };
    ...
    std::monostate listenForSettingChanges(
        ...
        (void)new EventListener(
            callback, SapphireSettingChangedFilter<T>(getMod()->getID(), settingKey)
        );
