...
namespace sapphire {
    ...
    template<class T>
    class SapphireSettingValue : public SettingValue {
    public:
    ...
    public:
        SapphireSettingValue(std::string const& key, std::string const& modID, T const& definition)
    ...
    using BoolSettingValue       = SapphireSettingValue<BoolSetting>;
    using IntSettingValue        = SapphireSettingValue<IntSetting>;
    using FloatSettingValue      = SapphireSettingValue<FloatSetting>;
    using StringSettingValue     = SapphireSettingValue<StringSetting>;
    using FileSettingValue       = SapphireSettingValue<FileSetting>;
    using ColorSettingValue      = SapphireSettingValue<ColorSetting>;
    using ColorAlphaSettingValue = SapphireSettingValue<ColorAlphaSetting>;
