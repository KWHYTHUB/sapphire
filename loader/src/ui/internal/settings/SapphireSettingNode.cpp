...
#include <Sapphire/binding/ColorChannelSprite.hpp>
...
InputNode* createInput(C* node, SapphireSettingValue<T>* setting, float width) {
...
template<class C, class T>
Slider* createSlider(C* node, SapphireSettingValue<T>* setting, float width) {
...
> createArrows(C* node, SapphireSettingValue<T>* setting, float width, bool big) {
...
void BoolSettingNode::valueChanged(bool updateText) {
    SapphireSettingNode::valueChanged(updateText);
