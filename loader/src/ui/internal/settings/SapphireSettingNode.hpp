...
template <class T>
class SapphireSettingNode : public SettingNode {
public:
...
protected:
    ...
    bool init(SapphireSettingValue<T>* setting, float width) {
        ...
        if (setting->castDefinition().description) {
            ...
            auto infoBtn = CCMenuItemSpriteExtra::create(
                infoSpr, this, menu_selector(SapphireSettingNode::onDescription)
            );
            infoBtn->setPosition(
        ...
        m_resetBtn = CCMenuItemSpriteExtra::create(
            resetBtnSpr, this, menu_selector(SapphireSettingNode::onReset)
        );
    ...
    virtual float setupHeight(SapphireSettingValue<T>* setting) const {
        return 40.f;
    }

    virtual bool setup(SapphireSettingValue<T>* setting, float width) = 0;
    ...
    SapphireSettingValue<T>* setting() {
        return static_cast<SapphireSettingValue<T>*>(m_value);
    }
...
class BoolSettingNode : public SapphireSettingNode<BoolSetting> {
protected:
...
class IntSettingNode :
    public SapphireSettingNode<IntSetting>,
...
class FloatSettingNode :
    public SapphireSettingNode<FloatSetting>,
    public TextInputDelegate
{
protected:
    InputNode* m_input = nullptr;
...
class StringSettingNode :
    public SapphireSettingNode<StringSetting>,
    public TextInputDelegate
{
protected:
    InputNode* m_input;
...
class FileSettingNode :
    public SapphireSettingNode<FileSetting>,
    public TextInputDelegate
{
protected:
    InputNode* m_input;
...
class ColorSettingNode :
    public SapphireSettingNode<ColorSetting>,
...
class ColorAlphaSettingNode :
    public SapphireSettingNode<ColorAlphaSetting>,
    public ColorPickPopupDelegate {
protected:
    ColorChannelSprite* m_colorSpr;
